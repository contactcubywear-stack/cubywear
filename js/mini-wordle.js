...
const WORDS_FR = {
  4: ["CHAT", "VELO", "LOUP", "MIEL", "FOUR", "JOUR", "BLEU", "ROSE", "MAIN", "PAIN", "VENT", "MURS", "RIRE", "LAIT", "TOIT", "NOIX", "FEUX", "BOIS", "MERS", "PORC",
      "PLAT", "ROUE", "TOUR", "FLOT", "MONT", "PONT", "SOIF", "FAIM", "PEUR", "VOIX", "DENT", "OEUF", "LAVE", "MARS", "JUIN", "NUIT", "JOIE", "PARC", "GARE", "PORT",
      "COUR", "COUP", "FORT", "VERT", "OURS"],
  5: ["TABLE", "CHIEN", "PORTE", "LIVRE", "PLAGE", "VERRE", "ARBRE", "FLEUR", "POMME", "GLACE", "MONDE", "DANSE", "FORCE", "CHAMP", "PLUME", "TIGRE", "SOEUR", "COEUR", "JAUNE", "ROUGE",
      "VOILE", "PLUIE", "NEIGE", "VAGUE", "FORET", "STYLO", "CADRE", "CARTE", "CHOSE", "IMAGE", "LARME", "MAGIE", "METRO", "MUSEE", "NUAGE", "RADIO", "ROBOT", "SABLE", "SALON", "SIGNE",
      "TASSE", "TERRE", "TRAIN", "VILLE"],
  6: ["GATEAU", "BATEAU", "OISEAU", "CADEAU", "BUREAU", "RIDEAU", "POULET", "MOUTON", "ORANGE", "BANANE", "VOYAGE", "MARCHE", "PLANTE", "VOISIN", "ANIMAL",
      "JARDIN", "PAPIER", "GROUPE", "PARFUM", "POESIE", "SOLEIL", "MIROIR", "ETOILE", "MOUCHE", "CHATON", "VALISE", "BOUGIE", "CRAYON", "DESSIN", "PONTON",
      "CANARD", "POISON", "BALLON", "RENARD", "TOMATE"]
};

const WORDS_EN = {
  4: ["WOLF", "CAKE", "DAWN", "BLUE", "ROSE", "HAND", "RAIN", "MILK", "ROOF", "NOSE", "FIRE", "WOOD", "PORK", "DUCK", "BOAT", "LAMP", "DESK", "BOOK", "FISH", "GOLD",
      "WIND", "SNOW", "STAR", "MOON", "TREE", "LEAF", "BIRD", "BEAR", "LION", "FROG", "DEER", "GOAT", "CORN", "RICE", "SOUP", "PLUM", "LIME", "MINT", "SALT", "IRON",
  ...
  5: ["TABLE", "CHAIR", "GLASS", "TIGER", "HEART", "WORLD", "DANCE", "FORCE", "FIELD", "FLOOR", "BREAD", "HOUSE", "MOUSE", "STONE", "CLOUD", "SMILE", "BEACH", "RIVER",
      "OCEAN", "CANDY", "SUGAR", "HONEY", "LEMON", "GRAPE", "PEACH", "MANGO", "BERRY", "WHEAT", "STORM", "CLOCK", "PHONE", "MUSIC", "PAINT", "BRUSH", "CHESS", "PIANO",
      "VOICE", "LIGHT", "NIGHT", "DREAM", "SPACE", "EARTH", "PLANE"],
  6: ["GARDEN", "BASKET", "ORANGE", "BANANA", "PLANET", "ANIMAL", "MARKET", "BRIDGE", "CASTLE", "FLOWER", "SILVER", "WINTER", "SUMMER", "YELLOW", "PURPLE",
      "PENCIL", "RABBIT", "MONKEY", "TURTLE", "SPIDER", "INSECT", "BOTTLE", "WINDOW", "CAMERA", "GUITAR", "DRAGON", "FOREST", "ISLAND", "DESERT", "JUNGLE",
      "SPRING", "AUTUMN", "BRONZE", "CIRCLE", "SQUARE"]
};
